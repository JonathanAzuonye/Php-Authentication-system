              ...
              <span class="help-block" style="color:#F90000;"><?php echo $password_err;?></span>                           
                        ...
                        <div>
                        	<button type="submit" class="bg-blue-600 font-semibold p-2 mt-5 rounded-md text-center text-white w-full">   Log In
                                      ...
                                      <center>
            <p class="rounded-md" style="font-size:10px;">Don't have an account? 
                   <a href="register.php" style="color:#2563EB;">Create account</a>
                      Or 
        <a href="password_reset.php" style="color:#2563EB;">Reset Password</a></p>
            </center>
                    </form>
                </div>
            </div>
            ...
            <!-- Footer -->
                ...
                <div class="flex flex-col items-center justify-between lg:flex-row max-w-6xl mx-auto lg:space-y-0 space-y-3">
                    ...
                    <p class="capitalize"> © Copyright 2021 by <a href="https://facebook.com/jonathan.azuonye.71/" style="color:2563EB;">Purple Team</a></p>
                </div>
            </div>
